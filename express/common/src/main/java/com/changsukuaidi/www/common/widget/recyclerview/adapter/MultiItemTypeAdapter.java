package com.changsukuaidi.www.common.widget.recyclerview.adapter;
...
import com.changsukuaidi.www.common.widget.recyclerview.base.ItemViewDelegateManager;
...
public class MultiItemTypeAdapter<T> extends RecyclerView.Adapter<ViewHolder>
{
    ...
    public void resetDatas(List<T> data) {
        clearData();
        mDatas.addAll(data);
    }
