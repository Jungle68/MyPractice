package com.changsukuaidi.www.widget.wheelview;
...
public class WheelView extends View {
    public static final float LINE_SPACE_MULTIPLIER = 3F;
    ...
    public static final int DIVIDER_COLOR = 0XFFEEEEEE;
    ...
    private boolean useWeight = true;//使用比重还是包裹内容？
    ...
    public final void setTextSize(float size) {
        if (size > 0.0F) {
            ...
            paintOuterText.setTextSize(DisplayUtils.sp2px(getContext(), textSize));
            paintCenterText.setTextSize(DisplayUtils.sp2px(getContext(), textSize));
        }
    }
    ...
    public void setTextPadding(int textPadding) {
        this.textPadding = DisplayUtils.dp2px(getContext(), textPadding);
    }
    ...
    private void remeasure() {
        ...
        if (useWeight) {
            ...
            if (textPadding < 0) {
                textPadding = DisplayUtils.dp2px(getContext(), ITEM_PADDING);
            }
    ...
    ArrayList<String> visibleItemStrings = new ArrayList<>();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        while (counter < visibleItemCount) {
            ...
            if (isLoop) {
                ...
                visibleItemStrings.add(counter, items.get(index).getName());
            } else if (index < 0) {
                visibleItemStrings.add(counter, "");
        ...
        while (counter < visibleItemCount) {
            ...
            if (angle >= 90F || angle <= -90F) {
                ...
                String tempStr = obtainContentText(visibleItemStrings.get(counter));
    ...
    private void remeasureTextSize(String contentText) {
        ...
        int size = DisplayUtils.sp2px(getContext(), textSize);
    ...
    private void measuredCenterContentStart(String content) {
        ...
        switch (gravity) {
            case Gravity.CENTER://显示内容居中
                ...
                break;
            case Gravity.START:
                drawCenterContentStart = DisplayUtils.dp2px(getContext(), 8);
                break;
    ...
    private void measuredOutContentStart(String content) {
        ...
        switch (gravity) {
            case Gravity.CENTER:
                ...
                break;
            case Gravity.START:
                drawOutContentStart = DisplayUtils.dp2px(getContext(), 8);
                break;
            case Gravity.END:
    ...
    public static class DividerConfig {
        ...
        int shadowColor = TEXT_COLOR_NORMAL;
        int shadowAlpha = 100;
        protected int alpha = DIVIDER_ALPHA;
        float ratio = 0f;
        float thick = DIVIDER_THICK;
         ...
         * 阴影是否可见
         */
        DividerConfig setShadowVisible(boolean shadowVisible) {
