package com.changsukuaidi.www.utils.recycler_itemdecoration;
...
public class GridDecoration extends RecyclerView.ItemDecoration {
    ...
    public void getItemOffsets(Rect outRect, int itemPosition,
        ...
        int raw = itemPosition / spanCount;
        ...
        outRect.set(column * width / spanCount,
                raw * height / rawCount,
                width - (column + 1) * width / spanCount,
                height - (raw + 1) * height / rawCount);
    }
}
