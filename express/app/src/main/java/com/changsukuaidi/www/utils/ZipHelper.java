...
public class ZipHelper {
     ...
     * @return
     */
    static String decompressToStringForZlib(byte[] bytesToDecompress) {
     ...
     * @return
     */
    private static byte[] decompressForZlib(byte[] bytesToDecompress) {
     ...
     * @return
     */
    private static byte[] compressForZlib(byte[] bytesToCompress) {
     ...
     * @throws IOException
     */
    static String decompressForGzip(byte[] compressed) {
